...
class PlaceBetsForm(forms.Form):
	...
	bet_expiration_date = forms.DateTimeField(label='Expiration Date/Time', help_text='Bet will no longer be available for others to accept after this datetime.', widget=forms.TextInput(attrs={'autocomplete':'off'}))
