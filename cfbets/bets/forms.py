...
class PlaceBetsForm(forms.Form):
	...
	odds = forms.DecimalField(label='Odds', initial=1.0, min_value=0, max_value=10, help_text="Use decimals e.g. 2.0 for 2:1 or .25 for 1:4.  Ratios relative to the proposer's side.", widget=forms.TextInput(attrs={'autocomplete':'off'}))
