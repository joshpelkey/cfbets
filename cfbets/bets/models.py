...
class ProposedBet (models.Model):
	...
	won_bet = models.IntegerField(choices=WIN_LOSS_TIE_CHOICES, null=True, blank=True)
...
# User Profile Audit creates an audit trail each time a user's winnings are updated due to an accepted bet being closed.
