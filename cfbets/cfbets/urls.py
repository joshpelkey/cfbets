...
from cfbets.forms import MyPasswordResetForm
...
urlpatterns = [
    ...
    url(r'^password_reset/$', auth_views.password_reset, {'template_name':
        'registration/password_reset_form.html', 'password_reset_form':
        MyPasswordResetForm},  name='password_reset'),
